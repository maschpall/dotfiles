...
This repo is to manage all dotfiles so they can be in sync with different machines

### Chezmoi

I created a cli function to generate aliases for diverse functions of chezmoi. Run chz instead of chezmoi help to see the aliases that i did.
...
When editing files that are not dotfiles, like the README, careful with the conflicts! So basically:
