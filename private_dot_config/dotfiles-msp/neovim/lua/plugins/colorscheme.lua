return {
  ...
  config = function()
    ...
    vim.g.nord_borders = false -- Enable th border between verticaly split windows visible
    ...
    vim.g.set_cursorline_transparent = false -- Sert the cursorline transparent/visible
    vim.g.nord_italic = false -- enables/disables italics
    vim.g.nord_enable_sidebar_background = false -- Re-enables the background of the sidebar if you disable the background of everything
    vim.g.nord_uniform_diff_background = true -- enables/disables colorful backgrounds when used
    ...
    -- Execute the function once after loadig the colorscheme
